    ...
    <section className="relative w-full py-12 sm:py-16 md:py-20 lg:py-28 overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            className="text-sm sm:text-base md:text-lg lg:text-xl text-foreground/70 max-w-2xl mx-auto mb-4 sm:mb-6 leading-relaxed px-2"
        ...
        >
          <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-accent/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-primary/20">
            ...
            >
              <a
                href="#contact"
                className="inline-block px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 text-sm sm:text-base bg-gradient-to-r from-primary to-accent text-white font-bold rounded-lg sm:rounded-xl shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transition-all duration-300"
              >
                تواصل معنا الآن
              </a>
            </motion.div>
